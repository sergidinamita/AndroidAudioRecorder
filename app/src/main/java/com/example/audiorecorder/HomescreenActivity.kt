...
class HomescreenActivity : AppCompatActivity()
{
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        // Text creator anim
        val byText: TextView = findViewById(R.id.textView2)
        val textAnimation2 = AnimationUtils.loadAnimation(this, R.anim.fade_rotate)
        byText.startAnimation(textAnimation2)
